      ...
      <div className=" flex">
        ...
        <div>
          <button className="border border-gray-300 rounded-r-full my-2  p-2 bg-gray-100 w-14 h-10 shadow-sm">
            <span
              className="material-symbols-outlined font-light px-3"
          ...
          <div className="fixed bg-white w-[500px] my-14 py-1 px-3 shadow-lg rounded-lg">
            <ul>
              {suggestions.map((s, i) => (
                ...
                >
                  <span className="material-symbols-outlined py-1 px-1 ">
                    {/* search */}
                    <AiOutlineSearch/>
                    </span>
        ...
        <span className="material-symbols-outlined m-3  hover:bg-gray-200 rounded-full p-2">
          {/* mic */}
          <BiSolidMicrophone size={25}/>
        </span>
      </div>
      <div className="flex">
        <span className="material-symbols-outlined font-thin m-4 hover:bg-gray-200 rounded-full py-1  pl-2 pr-2 ">
          {/* auto_videocam */}
          <RiVideoAddLine size={25}/>
        </span>
        <span className="material-symbols-outlined font-thin m-4  hover:bg-gray-200 rounded-full px-1 pl-1 pt-1">
          {/* notifications */}
        ...
        <img
          ...
          src={img}
          className="h-11 p-1 m-2 rounded-full"
        />
      </div>
    </div>
  );
